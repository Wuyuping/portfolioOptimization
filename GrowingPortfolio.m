function GrowingPortfolio()
    % Simulate using the min-variance allocation strategy. 
    % to grow the portfolio of 14 etfs
    % The parameter of this function is 
    % 1) The initial investment amount (i.e. the budbet B) 
    % 2) the minimum expected rate of return (r_min).
    % 3) k number of days used to estimate p_mean and sig 

    % Here the return/profit IS added to the capital (B). 
    % I.e. The combine B + return amount will rollover to the next day 
